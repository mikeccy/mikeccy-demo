import grails.plugins.springsecurity.SecurityConfigType // for cas
...
environments {
	...
	grails.serverURL = "http://localhost:8444/${appName}"
    }
    production {
...
grails.plugins.springsecurity.cas.serviceUrl = "http://localhost:8444/${appName}/j_spring_cas_security_check"
grails.plugins.springsecurity.cas.serverUrlPrefix = 'https://localhost:8443/cas'
grails.plugins.springsecurity.cas.proxyCallbackUrl = "http://localhost:8444/${appName}/secure/receptor"
grails.plugins.springsecurity.cas.proxyReceptorUrl = '/secure/receptor'
grails.plugins.springsecurity.logout.afterLogoutUrl = "https://localhost:8443/cas/logout?service=http://localhost:8444/${appName}/"
